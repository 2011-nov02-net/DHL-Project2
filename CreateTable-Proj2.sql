...
ALTER TABLE Class ADD CONSTRAINT FK_ClassDepartmentId_DepartmentID FOREIGN KEY (DepartmentId) REFERENCES Department(DepartmentId) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE Department ADD CONSTRAINT FK_DepartmentDean_Instructor FOREIGN KEY (DeanId) REFERENCES Instructor (InstructorId) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE Instructor ADD CONSTRAINT FK_InstructorDepartmentId_Department FOREIGN KEY (DepartmentId) REFERENCES Department (Id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE Instructor ADD CONSTRAINT FK_InstructorId_PersonID FOREIGN KEY (InstructorId) REFERENCES Person (Id) ON DELETE CASCADE ON UPDATE CASCADE;
